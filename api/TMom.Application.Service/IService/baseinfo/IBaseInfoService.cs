...
namespace TMom.Application.Service.IService
{
	...
	/// IBaseInfoService
	/// </summary>
    public interface IBaseInfoService: IBaseService<BaseInfo, int>
	{
        /// <summary>
        /// 分页获取数据
        /// </summary>
        ...
        /// <returns></returns>
        Task<PageModel<BaseInfo>> GetWithPage((Expression<Func<BaseInfo, bool>>, List<FormattableString>) whereExp, int pageIndex, int pageSize, string orderByFields = "");
        ...
        /// <returns></returns>
        Task<int> AddData(BaseInfo entity);
        ...
        Task<bool> UpdateData(BaseInfo entity);
