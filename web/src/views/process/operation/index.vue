<template>
  <div>
    ...
    >
      ...
      <template #toolbar>
        <a-button v-if="$auth('/api/ProcessOperation/Add')" type="primary" @click="openModal({})">
          {{ t('common.add') }}
        </a-button>
        ...
        <a-button
          v-if="$auth('/api/ProcessOperation/Delete')"
          type="error"
...
<script lang="tsx" setup>
  ...
  import action from '@/api/process/operation'
      ...
      actions: ({ record }) => [
        {
          label: t('common.edit'),
          auth: {
            perm: '/api/ProcessOperation/Update',
            effect: 'disable',
          },
        ...
        },
        {
          ...
          danger: true,
          auth: {
            perm: '/api/ProcessOperation/Delete',
            effect: 'disable',
          },
          popConfirm: {
