<template>
  <div>
    ...
    >
      ...
      <template #toolbar>
        <a-button v-if="$auth('/api/FailureSymptom/Add')" type="primary" @click="openModal({})">
          {{ t('common.add') }}
        </a-button>
        ...
        <a-button
          v-if="$auth('/api/FailureSymptom/Delete')"
          type="error"
...
<script lang="tsx" setup>
  ...
  import action from '@/api/base/failureSymptom'
      ...
      actions: ({ record }) => [
        {
          label: t('common.edit'),
          auth: {
            perm: '/api/FailureSymptom/Update',
            effect: 'disable',
          },
        ...
        },
        {
          ...
          danger: true,
          auth: {
            perm: '/api/FailureSymptom/Delete',
            effect: 'disable',
          },
          popConfirm: {
