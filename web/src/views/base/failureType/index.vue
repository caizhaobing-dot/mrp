<template>
  <div>
    ...
    >
      ...
      <template #toolbar>
        <a-button v-if="$auth('/api/FailureType/Add')" type="primary" @click="openModal({})">
          {{ t('common.add') }}
        </a-button>
        ...
        <a-button
          v-if="$auth('/api/FailureType/Delete')"
          type="error"
...
<script lang="tsx" setup>
  ...
  import action from '@/api/base/failureType'
