<template>
  <div>
    ...
    >
      ...
      <template #toolbar>
        <a-button v-if="$auth('/api/RepairMethod/Add')" type="primary" @click="openModal({})">
          {{ t('common.add') }}
        </a-button>
        ...
        <a-button
          v-if="$auth('/api/RepairMethod/Delete')"
          type="error"
...
<script lang="tsx" setup>
  ...
  import action from '@/api/base/repairMethod'
