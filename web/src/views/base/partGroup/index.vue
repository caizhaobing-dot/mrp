<template>
  <div>
    ...
    >
      ...
      <template #toolbar>
        <a-button v-if="$auth('/api/PartGroup/Add')" type="primary" @click="openModal({})">
          {{ t('common.add') }}
        </a-button>
        ...
        <a-button
          v-if="$auth('/api/PartGroup/Delete')"
          type="error"
...
<script lang="tsx" setup>
  ...
  import action from '@/api/base/partGroup'
