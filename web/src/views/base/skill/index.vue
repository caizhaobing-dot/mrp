<template>
  <div>
    ...
    >
      ...
      <template #toolbar>
        <a-button v-if="$auth('/api/Skill/Add')" type="primary" @click="openModal({})">
          {{ t('common.add') }}
        </a-button>
...
<script lang="tsx" setup>
  ...
  import action from '@/api/base/skill'
