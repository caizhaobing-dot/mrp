<template>
  <div>
    ...
    >
      ...
      <template #toolbar>
        <a-button v-if="$auth('/api/MaterialReplace/Add')" type="primary" @click="openModal({})">
          {{ t('common.add') }}
        </a-button>
        ...
        <a-button
          v-if="$auth('/api/MaterialReplace/Delete')"
          type="error"
...
<script lang="tsx" setup>
  ...
  import action from '@/api/base/materialReplace'

  defineOptions({
    name: 'MaterialReplace',
  })
      ...
      actions: ({ record }) => [
        {
          label: t('common.edit'),
          auth: {
            perm: '/api/MaterialReplace/Update',
            effect: 'disable',
          },
        ...
        },
        {
          ...
          danger: true,
          auth: {
            perm: '/api/MaterialReplace/Delete',
            effect: 'disable',
          },
          popConfirm: {
